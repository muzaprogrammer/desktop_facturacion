...
namespace CapaPresentacion
{
    public partial class FormLogin : Form
    {
        ...
        {
            DataTable Datos = CapaNegocio.NEmpleado.Login(this.txtPasword.Text, this.txtUsuario.Text);
            ...
            {
                MessageBox.Show("SI tiene acceso al sistema", "Sistema de reservaciones", MessageBoxButtons.OK, MessageBoxIcon.Error);
                /*
